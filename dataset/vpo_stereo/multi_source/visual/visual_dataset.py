...
class VisualDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        transformed_pack = self.transform(image, label)
        if self.mode == "train":
            image, label, chosen_flip = transformed_pack
        else:
            image, label = transformed_pack
        # TODO
        ...
        return image, label, class_label, self.name_list[idx], chosen_flip
