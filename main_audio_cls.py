...
def main(local_rank, ngpus_per_node, hyp_param_):
    ...
    optimizer_a = torch.optim.Adam(params=model_a.parameters(), lr=1e-4)
    ...
    from trainer.baseline_audio import BASELINE
    trainer = BASELINE(
        hyp_param_,
        train_loader,
        engine=engine,
    ...
    ckpt = torch.load("./ckpts/save_models/[R50][BS16][G1]DeepLabV3Plus/best_model.pth")['model']
    ...
    # trainer.validation(model_v, model_a, 0, test_loader)
